...
export function AcademySectionCard({
  ...
  return (
    <article className="group relative flex flex-col rounded-main bg-primary/10 p-7 text-primary transition duration-300 ~min-h-[12rem]/[17.5rem] hover:text-primary-foreground">
      <Link
        to={link}
