...
export function DocumentCardSkeleton({
  ...
  return (
    <div
      className={cn(
        "bg-card rounded-main relative z-10 before:bg-[url(/pattern.webp)] before:bg-no-repeat before:bg-cover flex flex-col before:bg-center before:absolute before:inset-0 before:opacity-[0.06] before:-z-10 ~py-3/5 ~px-4/7",
        className
      )}
      {...props}>
